...
import com.alibaba.csp.switchcenter.util.PidUtil;
import com.alibaba.csp.switchcenter.util.StringUtil;

/**
 * Default log base dir is ${user.home}/logs/csp/, we can use {@link #LOG_DIR}
 * System property to override it. Default log file name dose not contain pid,
 * but if multi instances of the same app are running in the same machine, we
 * may want to distinguish the log file by pid number, in this case,
 * {@link #LOG_NAME_USE_PID} System property could be configured as "true" to
 * turn on this switch.
 *
 * @author leyou
 */
public class LogBase {
     ...
     */
    private static final String LOG_OUTPUT_TYPE_FILE = "file";
    /**
     * Output biz log(RecordLog,CommandCenterLog) to console
     */
    private static final String LOG_OUTPUT_TYPE_CONSOLE = "console";
     ...
     */
    private static final String LOG_OUTPUT_TYPE = "csp.sentinel.log.output.type";
    private static final String LOG_DIR = "csp.sentinel.log.dir";
    private static final String LOG_NAME_USE_PID = "csp.sentinel.log.use.pid";
    ...
    private static void init() {
        ...
        } else if (!LOG_OUTPUT_TYPE_FILE.equalsIgnoreCase(logOutputType)
    ...
    /**
     * Whether log file name should contain pid. This switch is configured by
     * {@link #LOG_NAME_USE_PID} System property.
     *
     * @return if log file name should contain pid, return true, otherwise return
     * false.
     */
    ...
    protected static Handler makeLogger(String logName, Logger heliumRecordLog) {
        ...
        if (LOG_OUTPUT_TYPE_FILE.equals(logOutputType)) {
        ...
        } else if (LOG_OUTPUT_TYPE_CONSOLE.equals(logOutputType)) {
            try {
